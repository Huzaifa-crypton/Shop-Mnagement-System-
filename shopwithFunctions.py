...
idx = 2                                   #salesperson index
idx1 = 2                                  #added items index
...
def replace_salesperson() :
    ...
    password_salesperson = int (input("Enter new PASSWORD: "))
    add_salesperson(uname_salesperson , pass_salesperson , (option1-1))
...
def replace_items() :
    ...
    add_items(item_name , quantity , org_price , s_price , (option1-1) )
